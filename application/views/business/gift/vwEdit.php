    			    ...
    			    <div class="col-sm-12">
    			        <div class="portlet box blue">
        			        <div class="portlet-title">
    							<div class="caption">
    								<i class="fa fa-pencil-square-o"></i> Gift Edit
    							</div>     							
    						</div>
                                ...
                                <form method="POST" action="<?php echo base_url();?>business/gift/save" class="form-horizontal margin-top-normal" role="form" enctype='multipart/form-data'>
                                    ...
                                    ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="form-control-static"><?php echo $gift->{$key}?></p>
                                            </div>
                                        </div>
                                    <?php 
                                        } else {
                                    ?>
                                        <div class="form-group">
                                            <label for="<?php echo $value;?>" class="col-sm-2 col-sm-offset-1 control-label"><?php echo $value;?></label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="<?php echo $key;?>" type="<?php echo ($key == 'thumb') ? 'file' : 'text';?>" value='<?php echo set_value($key, $gift->{$key}); ?>'>
                                            </div>
                                        </div>                        
                                    <?php
                                        }
